...
<span class="group_widget_link"><a href="<?php echo $vars['url'] . "pg/googleapps/docs/" . page_owner_entity()->username; ?>"><?php echo elgg_echo('link:view:all')?></a></span>
...
<?php
	...
	if ($docs) {
		...
		$share_document = $vars['url'] . "pg/googleapps/docs/share?container_guid=" . page_owner_entity()->getGUID();

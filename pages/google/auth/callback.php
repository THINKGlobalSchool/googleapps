...
$g_state = $_SESSION['google_login_state'];
...
} else if ($_SESSION['google_access_token']) {
...
if (!$entities) {
	...
	if (!$_SESSION['google_connect_account']) {
...
if (!$_SESSION['google_connect_account']) {
	...
	$_SESSION['google_connect_account'] = FALSE;
	system_message(elgg_echo('googleapps:success:manual_connect'));
}

// Forward on
if ($_SESSION['google_connect_alt_forward']) {
	$forward_url = $_SESSION['google_connect_alt_forward'];
	$_SESSION['google_connect_alt_forward'] = null;
	forward($forward_url);
} else if ($_SESSION['last_forward_from']) {
	$forward_url = $_SESSION['last_forward_from'];
	$_SESSION['last_forward_from'] = null;
	forward($forward_url);
} else {
	forward();
}
